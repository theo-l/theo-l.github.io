...
if __name__ == "__main__":
    ...
    print('\n', '{MAP} function iteration context:', map_result, isinstance(map_result, collections.Iterator),
          f'\n{"-"*50}\n')
    filter_result = filter(lambda o: o % 2 == 0, iterable_object)
    print('\n', '{FILTER} function iteration context:', filter_result, isinstance(filter_result, collections.Iterator),
          f'\n{"-"*50}\n')
    zip_result = zip(iterable_object, iterable_object2)
    print('\n', '{ZIP} function iteration context:', zip_result, isinstance(zip_result, collections.Iterator),
          f'\n{"-"*50}\n')
