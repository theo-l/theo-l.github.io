...
def check_bottle_decoration(bottle):
    print(f'Bottle <{bottle.__name__}> is decorated with {{{getattr(bottle, "decoration")}}}' if getattr(
        bottle, 'decoration', False) else f'Bottle <{bottle.__name__}> has not been decorated')
